...
setup(
    ...
    version="0.1.0",
    author="Mike Warner",
    author_email="533026+minimike86@users.noreply.github.com",
    ...
    entry_points={
        "console_scripts": [
            "qrl-server=examples.basic_server:main",
            "qrl-client=examples.basic_client:main",
        ],
    },
    include_package_data=True,
    zip_safe=False,
    keywords="qr-code exfiltration poc security-research red-team",
    project_urls={
